...
import { HumbergerMenu } from "../../Home/Header/HumburgerMenu";
    ...
    return(
        <div className="my-[5px] m-auto">
            <div className="flex justify-center items-center h-[90px]">
                ...
                <HumbergerMenu
                    CustomClassName="text-[14px] border-[#1d1b2c]] text-[#1d1b2c] hover:opacity-80 hover:bg-[#1d1b2c] hover:text-[#ffffff]"
